...
namespace __gnu_cxx { //_GLIBCXX_BEGIN_NAMESPACE(__gnu_cxx)
  ...
  template<typename _Tp, typename _Up, typename _Vp>
    struct __promote_3<std::complex<_Tp>, _Up, _Vp>
    {
    public:
      typedef std::complex<typename __promote_3<_Tp, _Up, _Vp>::__type> __type;
    };

  template<typename _Tp, typename _Up, typename _Vp>
    struct __promote_3<_Tp, std::complex<_Up>, _Vp>
    {
    public:
      typedef std::complex<typename __promote_3<_Tp, _Up, _Vp>::__type> __type;
    };
  ...
  template<typename _Tp, typename _Up, typename _Vp>
    struct __promote_3<_Tp, _Up, typename std::complex<_Vp> >
    {
    public:
      typedef std::complex<typename __promote_3<_Tp, _Up, _Vp>::__type> __type;
    };
  ...
  template<typename _Tp, typename _Up, typename _Vp>
    struct __promote_3<std::complex<_Tp>, std::complex<_Up>, _Vp >
    {
    public:
      typedef std::complex<typename __promote_3<_Tp, _Up, _Vp>::__type> __type;
    };
  ...
  template<typename _Tp, typename _Up, typename _Vp>
    struct __promote_3<_Tp, std::complex<_Up>, std::complex<_Vp> >
    {
    public:
      typedef std::complex<typename __promote_3<_Tp, _Up, _Vp>::__type> __type;
    };
  ...
  template<typename _Tp, typename _Up, typename _Vp>
    struct __promote_3<std::complex<_Tp>, _Up, std::complex<_Vp> >
    {
    public:
      typedef std::complex<typename __promote_3<_Tp, _Up, _Vp>::__type> __type;
    };
  ...
  template<typename _Tp, typename _Up, typename _Vp>
    struct __promote_3<std::complex<_Tp>, std::complex<_Up>, std::complex<_Vp> >
    {
    public:
      typedef std::complex<typename __promote_3<_Tp, _Up, _Vp>::__type> __type;
    };
...
main()
{
  ...
  std::cout << "rf(1, 2, 0) = " << __gnu_cxx::ellint_rf(1.0, 2.0, 0.0) << std::endl;  //  1.3110287771461
  std::cout << "rf(i, -i, 0) = " << __gnu_cxx::ellint_rf(std::complex<double>(0.0, 1.0),
						 std::complex<double>(0.0, -1.0),
						 0.0) << std::endl;  //  1.8540746773014;
  std::cout << "rf(i - 1, i, 0) = " << __gnu_cxx::ellint_rf(std::complex<double>(-1.0, 1.0),
						    std::complex<double>(0.0, 1.0),
						    0.0) << std::endl;  //  0.79612586584234 - i 1.2138566698365
  std::cout << "rf(0.5, 1, 0) = " << __gnu_cxx::ellint_rf(0.5, 1.0, 0.0) << std::endl;  //  1.8540746773014
  std::cout << "rf(2, 3, 4) = " << __gnu_cxx::ellint_rf(2.0, 3.0, 4.0) << std::endl;  //  0.58408284167715
  std::cout << "rf(i, -i, 2) = " << __gnu_cxx::ellint_rf(std::complex<double>(0.0, 1.0),
						 std::complex<double>(0.0, -1.0),
						 2.0) << std::endl;  //  1.0441445654064
  std::cout << "rf(i - 1, 1 - i, i) = " << __gnu_cxx::ellint_rf(std::complex<double>(-1.0, 1.0),
							std::complex<double>(1.0, -1.0),
							std::complex<double>(0.0, 1.0)) << std::endl;  //  0.93912050218619 - i 0.53296252018635

  std::cout << std::endl;

  std::cout << "rc(0, 1/4) = " << __gnu_cxx::ellint_rc(0.0, 0.25) << std::endl;  //  pi = 3.1415926535898
  std::cout << "rc(9/4, 2) = " << __gnu_cxx::ellint_rc(2.25, 2.0) << std::endl;  //  ln 2 = 0.69314718055995
  std::cout << "rc(0, i) = " << __gnu_cxx::ellint_rc(0.0,
						       std::complex<double>(0.0, 1.0)) << std::endl;  //  (1 - i) 1.1107207345396
  std::cout << "rc(-i, i) = " << __gnu_cxx::ellint_rc(std::complex<double>(0.0, -1.0),
							std::complex<double>(0.0, 1.0)) << std::endl;  //  1.2260849569072 - i 0.34471136988768
  std::cout << "rc(1/4, -2) = " << __gnu_cxx::ellint_rc(0.25, -2.0) << std::endl;  //  ln 2/3 = 0.23104906018665
  std::cout << "rc(i, -1) = " << __gnu_cxx::ellint_rc(std::complex<double>(0.0, 1.0),
							-1.0) << std::endl;  //  0.77778596920447 + i 0.19832484993429

  std::cout << std::endl;

  std::cout << "rj(0, 1, 2, 3) = " << __gnu_cxx::ellint_rj(0.0, 1.0, 2.0, 3.0) << std::endl;  //  0.77688623778582
  std::cout << "rj(2, 3, 4, 5) = " << __gnu_cxx::ellint_rj(2.0, 3.0, 4.0, 5.0) << std::endl;  //  0.14297579667157
  std::cout << "rj(2, 3, 4, -1 + i) = " << __gnu_cxx::ellint_rj(2.0,
								  3.0,
								  4.0,
								  std::complex<double>(-1.0,1.0)) << std::endl;  //  0.13613945827771 - i 0.38207561624427
  std::cout << "rj(i, -i, 0, 2) = " << __gnu_cxx::ellint_rj(std::complex<double>(0.0,1.0),
							      std::complex<double>(0.0,-1.0),
							      0.0,
					     		      2.0) << std::endl;  //  1.6490011662711
  std::cout << "rj(-1 + i, -1 - i, 1, 2) = " << __gnu_cxx::ellint_rj(std::complex<double>(-1.0,1.0),
							     std::complex<double>(-1.0,-1.0),
							     1.0,
							     2.0) << std::endl;  //  0.94148358841220
  std::cout << "rj(i, -i, 0, 1 - i) = " << __gnu_cxx::ellint_rj(std::complex<double>(0.0,1.0),
							std::complex<double>(0.0,-1.0),
							0.0,
							std::complex<double>(1.0,-1.0)) << std::endl;  //  1.8260115229009 + i 1.2290661908643
  std::cout << "rj(-1 + i, -1 - i, 1, -3 + i) = " << __gnu_cxx::ellint_rj(std::complex<double>(-1.0,1.0),
								  std::complex<double>(-1.0,-1.0),
								  1.0,
								  std::complex<double>(-3.0,1.0)) << std::endl;  //  -0.61127970812028 - i 1.0684038390007
  std::cout << "rj(-1 + i, -2 - i, -i, -1 + i) = " << __gnu_cxx::ellint_rj(std::complex<double>(-1.0,1.0),
  ...
  std::cout << "rd(0, 2, 1) = " << __gnu_cxx::ellint_rd(0.0, 2.0, 1.0) << std::endl;  //  1.7972103521034
  std::cout << "rd(2, 3, 4) = " << __gnu_cxx::ellint_rd(2.0, 3.0, 4.0) << std::endl;  //  0.16510527294261
  std::cout << "rd(i, -i, 2) = " << __gnu_cxx::ellint_rd(std::complex<double>(0.0,1.0),
						 std::complex<double>(0.0,-1.0),
						 2.0) << std::endl;  //  0.65933854154220
  std::cout << "rd(0, i, -i) = " << __gnu_cxx::ellint_rd(0.0,
						 std::complex<double>(0.0,1.0),
						 std::complex<double>(0.0,-1.0)) << std::endl;  //  1.2708196271910 + i 2.7811120159521
  std::cout << "rd(0, i - 1, i) = " << __gnu_cxx::ellint_rd(0.0,
						    std::complex<double>(-1.0,1.0),
						    std::complex<double>(0.0,1.0)) << std::endl;  //  -1.8577235439239 - i 0.96193450888839
  std::cout << "rd(-2 - i, -i, -1 + i) = " << __gnu_cxx::ellint_rd(std::complex<double>(-2.0,-1.0),
							   std::complex<double>(0.0,-1.0),
							   std::complex<double>(-1.0,1.0)) << std::endl;  //  1.8249027393704 - i 1.2218475784827

  std::cout << std::endl;

  std::cout << "rg(0, 16, 16) = 2E(0) = pi = " << __gnu_cxx::ellint_rg(0.0, 16.0, 16.0) << std::endl;  //  3.1415926535898
  std::cout << "rg(2, 3, 4) = " << __gnu_cxx::ellint_rg(2, 3, 4) << std::endl;  //  1.725503020692
  std::cout << "rg(0, i, -i) = " << __gnu_cxx::ellint_rg(0.0,
						 std::complex<double>(0.0,1.0),
						 std::complex<double>(0.0,-1.0)) << std::endl;  //  0.42360654239699
  std::cout << "rg(i - 1, i, 0) = " << __gnu_cxx::ellint_rg(std::complex<double>(-1.0,1.0),
						  std::complex<double>(0.0,1.0),
						  0.0) << std::endl;  //  0.44660591677018 + i 0.70768352357515
  std::cout << "rg(-i, i - 1, i) = " << __gnu_cxx::ellint_rg(std::complex<double>(0.0,-1.0),
						  std::complex<double>(-1.0,1.0),
						  std::complex<double>(0.0,1.0)) << std::endl;  //  0.36023392184473 + i 0.40348623401722
  std::cout << "rg(0, 0.0796, 4) = E(0.99) = " << __gnu_cxx::ellint_rg(0,0.0796,4) << std::endl;  //  1.0284758090288

  std::cout << std::endl;

  std::cout << "rf<int>(1, 2, 0) = " << __gnu_cxx::ellint_rf<int>(1.0, 2.0, 0.0) << std::endl;  //  1.3110287771461
